...
class CreateCustomChallengeViewController: UIViewController {
  ...
  /// Launcher to show Datepicker in the bottom o screen
  ...
  /// CAll back method for launcher
  ///
  /// - Parameter notif: UINotifications
  ...
  /// This methods creates notifications in UIUserNotificationCenter
  ///
  ...
  /// Call back Method for receiving new challenge location
  ///
  /// - Parameter notif: UINotification
