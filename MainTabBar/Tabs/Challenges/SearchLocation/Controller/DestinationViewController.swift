...
/// This controller allows the user to search for a challenge destination and store it into a challenge
class DestinationViewController: UIViewController, UISearchBarDelegate {
  ...
  /// Callback function to display searchBar
  ///
  ...
  /// Trigger the serach with query from search bar and displays on map
  ///
