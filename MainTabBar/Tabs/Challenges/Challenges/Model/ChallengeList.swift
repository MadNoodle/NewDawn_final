...
/// This Model contains predefined Challenges for all categories
struct ChallengeList {
  
  /// Allows the user to fetch categories challenges in controller
  ///
  /// - Parameter category: String Category Name
  /// - Returns: [String] 
