...
class ProgressViewController: UIViewController, EditableChallenge {
  /// Property to store and retrieve firebase key for challenge
  var challengeKey: String?
  /// EditableChallenge protocol conformance to recieve the selected challenge
  var challengeToSend: Challenge?

  // ////////////////// //
  // MARK: - PROPERTIES //
  // ////////////////// //
  /// Allows to store map as data
  ...
  /// Property to initiate by timer to to draw MKPolyline path
  var seconds = 0
  /// Timer to draw MKPolyline
  var timer: Timer?
  /// Minimum distance between to points of MK Polyline
  ...
  /// Callback function to edit selected challenge
