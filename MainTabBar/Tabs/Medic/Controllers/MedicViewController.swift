...
/// This Vc handle the Medic search by geolocalisation
class MedicViewController: UIViewController {

  // //////////// //
  // MARK: - DATA //
  // //////////// //
  /// This properties contains the data
  ...
  /// Location Manager that will handle localization
  let locationManager = CLLocationManager()
  /// Region to be displayed
  let regionRadius: CLLocationDistance = 100
  /// Property that stores user's location
  var coordinates: CLLocationCoordinate2D?

  // ////////////////////////////////////////// //
  // MARK: - Detail View Properties and outlets //
  // ////////////////////////////////////////// //
  /// Detail View heigth constraint that is animated to show the view
