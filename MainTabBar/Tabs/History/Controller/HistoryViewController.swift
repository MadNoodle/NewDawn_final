...
class HistoryViewController: UIViewController, ChartViewDelegate {
  ...
  /// Property to store and retrieve moods from firebase
  internal var dataSet: [Mood]?
  /// Property to store and retrieve Challenges from firebase
  internal var dataPoints: [Challenge]?
  /// Property to store unfiltered challenges history
  internal var history: [Challenge] = []
  /// Property to store and retrieve number of succeeded challenge
  var amountOfSucceededChallenge: Int = 0
  /// Property to store the percentage of succeeded challenges// total challenges
  var progress = 0.0
  /// Property to store and retrieve current user from user defaults
  var currentUser = ""
  /// Custom cell reuse  identifier
  let reuseId = "myCell"
